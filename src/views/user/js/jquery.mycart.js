...
(function ($) {
    ...
    var loadMyCartEvent = function (userOptions) {
        ...
        if (!$("#" + idCartModal).length) {
            $('body').append(
                ...
                '<button type="button" class="btn btn-primary" id="settlement_button" data-toggle="modal" data-target="#settlement" data-dismiss="modal" >结&nbsp;算</button>' +
    ...
    $.fn.logout = function (options) {
        this.click(function () {
            ProductManager.clearProduct();
            window.location.href = "../../controllers/userController.php?type=logout&dst=user/user_login.php";
        })
    };
